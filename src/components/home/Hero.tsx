          ...
          <div className="w-full lg:w-1/2 text-center lg:text-right order-2 lg:order-1">
            <div className="space-y-6 max-w-xl mx-auto lg:mr-0 lg:ml-auto">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                <span className="block">تسوق بكل سهولة</span>
                <span className="text-primary">من أي مكان</span>
              </h1>
              
              <p className="text-foreground/70 text-lg">
                نقدم لك تجربة تسوق فريدة مع مجموعة متنوعة من المنتجات عالية الجودة وخدمة توصيل سريعة لجميع مناطق ليبيا.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-6 border-t border-border/30 mt-8">
                <div className="bg-background/50 backdrop-blur-sm p-3 rounded-lg shadow-sm">
                ...
                <div className="bg-background/50 backdrop-blur-sm p-3 rounded-lg shadow-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="text-sm font-medium">جودة ممتازة</div>
                  </div>
                </div>
                <div className="bg-background/50 backdrop-blur-sm p-3 rounded-lg shadow-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="text-sm font-medium">دعم على مدار الساعة</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2">
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-tr from-primary/20 to-secondary/20 rounded-2xl overflow-hidden shadow-2xl">
                <img 
                  src="https://images.unsplash.com/photo-1607082349566-187342175e2f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80" 
                  alt="تسوق أونلاين"
